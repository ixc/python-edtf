...
from edtf.parser.parser_classes import EDTFObject, TIME_EMPTY_TIME, TIME_EMPTY_EXTRAS
...
def test_edtf_examples(test_input, expected_tuple):
    ...
    if len(expected_tuple) == 1:
        assert result_date == expected_tuple[0], f"Expected {expected_tuple[0]}, got {result_date}"
