...
oneThru12 = oneOf([f"{i:.2d}" for i in range(1, 13)])
oneThru13 = oneOf([f"{i:.2d}" for i in range(1, 14)])
oneThru23 = oneOf([f"{i:.2d}" for i in range(1, 24)])
zeroThru23 = oneOf([f"{i:.2d}" for i in range(0, 24)])
oneThru29 = oneOf([f"{i:.2d}" for i in range(1, 30)])
oneThru30 = oneOf([f"{i:.2d}" for i in range(1, 31)])
oneThru31 = oneOf([f"{i:.2d}" for i in range(1, 32)])
oneThru59 = oneOf([f"{i:.2d}" for i in range(1, 60)])
zeroThru59 = oneOf([f"{i:.2d}" for i in range(0, 60)])
